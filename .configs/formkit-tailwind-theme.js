...
export default {
  ...
  global: {
    ...
    label: 'absolute flex items-center -z-[1] px-3 text-grey-500 dark:text-grey-500 text-base group-focus-within:text-xs top-4 group-focus-within:top-5 group-focus-within:-translate-y-full formkit-complete:text-xs formkit-complete:top-5 formkit-complete:-translate-y-full formkit-invalid:text-xs formkit-invalid:top-5 formkit-invalid:-translate-y-full transform transition-all duration-100 ease-linear',
  ...
  'family:button': {
    input:
      '$reset bg-black dark:bg-white text-white dark:text-black text-sm font-bold uppercase w-full py-4 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
    wrapper: 'mb-1',
  ...
  'family:text': {
    ...
    input:
      ...
      'rounded w-full outline-none my-0 pb-2 pt-7 px-3 text-base leading-tight text-grey-900 dark:text-white bg-transparent dark:bg-transparent border border-grey-200 dark:border-grey-800 group-hover:border-grey-975 dark:group-hover:border-white focus:ring-1 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white focus-visible:border-black focus-visible:ring-black transform transition-all duration-200 ease-in-out',
